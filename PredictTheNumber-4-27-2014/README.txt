I am purposely doing this code kata the "stupid" way in order to compare benchmarks between recursive and iterative solutions for this problem in order to do a blog post on the topic.
